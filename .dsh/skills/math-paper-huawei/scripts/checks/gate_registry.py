...
GATES = (
    ...
    GateSpec("check_python_figure_contract.py", 3, stage_argument=True),
    GateSpec("check_python_figure_quality.py", 3),
    GateSpec("check_python_bar_chart_policy.py", 3),
    GateSpec("check_python_subplot_policy.py", 3, stage_argument=True),
    ...
    GateSpec("check_excellent_paper_visual_reference.py", 4),
    ...
    GateSpec("check_figure_table_numbering.py", 4),
