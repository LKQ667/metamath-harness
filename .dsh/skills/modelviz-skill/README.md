...
ModelViz 是一个面向数学建模竞赛和科研报告的科学可视化 Skill，将上述流程整理成可复用工作流：内置近百个正式科学可视化模板，配套上百个预览与模板资产，覆盖聚类降维、相关性、分布不确定性、预测评估、敏感性分析、网络关系、空间分析和时序趋势等方向。
  ...
  <table width="100%">
    <tr>
      <td width="50%" align="center">
        <img src="templates/01_CLU_clustering_reduction/01_CLU_001/assets/preview.png" alt="聚类关联矩阵预览" width="100%">
        <br>
        <sub>聚类关联矩阵</sub>
      </td>
      <td width="50%" align="center">
    ...
    <tr>
      <td width="50%" align="center">
        <img src="templates/10_SEN_sensitivity_robustness/10_SEN_005/assets/preview.png" alt="GAM 等高线面板预览" width="100%">
        <br>
        <sub>GAM 等高线面板</sub>
      </td>
      <td width="50%" align="center">
        <img src="templates/10_SEN_sensitivity_robustness/10_SEN_011/assets/preview.png" alt="SHAP 交互网络预览" width="100%">
        <br>
        <sub>SHAP 交互网络</sub>
      </td>
    </tr>
    <tr>
      <td width="50%" align="center">
        <img src="templates/09_REL_relationship_correlation/09_REL_005/assets/preview.png" alt="三角相关热力图预览" width="100%">
        <br>
        <sub>三角相关热力图</sub>
      </td>
      <td width="50%" align="center">
        <img src="templates/09_REL_relationship_correlation/09_REL_013/assets/preview.png" alt="三角网络相关图预览" width="100%">
        <br>
        <sub>三角网络相关图</sub>
      </td>
    </tr>
    <tr>
      ...
      <td width="50%" align="center">
        <img src="templates/03_EVL_composite_evaluation/03_EVL_002/assets/preview.png" alt="径向综合评价预览" width="100%">
        <br>
        <sub>径向综合评价</sub>
      </td>
    </tr>
    <tr>
      ...
      <td width="50%" align="center">
        <img src="templates/02_CMP_comparison_ranking/02_CMP_001/assets/preview.png" alt="环形柱状对比预览" width="100%">
        <br>
        <sub>环形柱状对比</sub>
      </td>
    </tr>
    <tr>
      ...
      <td width="50%" align="center">
        <img src="templates/02_CMP_comparison_ranking/02_CMP_012/assets/preview.png" alt="热力图排名矩阵预览" width="100%">
        <br>
        <sub>热力图排名矩阵</sub>
      </td>
    </tr>
    <tr>
      <td width="50%" align="center">
        <img src="templates/04_DIS_distribution_uncertainty/04_DIS_006/assets/preview.png" alt="小提琴分布矩阵预览" width="100%">
        <br>
        <sub>小提琴分布矩阵</sub>
      </td>
      <td width="50%" align="center">
        <img src="templates/05_MPN_multi_panel_report/05_MPN_004/assets/preview.png" alt="三维响应面组合预览" width="100%">
        <br>
        <sub>三维响应面组合</sub>
      </td>
    </tr>
    <tr>
      <td width="50%" align="center">
        <img src="templates/09_REL_relationship_correlation/09_REL_016/assets/preview.png" alt="扇形相关热力图预览" width="100%">
        <br>
        <sub>扇形相关热力图</sub>
      </td>
      <td width="50%" align="center">
        <img src="templates/09_REL_relationship_correlation/09_REL_017/assets/preview.png" alt="边际回归散点图预览" width="100%">
        <br>
        <sub>边际回归散点图</sub>
      </td>
    </tr>
    <tr>
      <td width="50%" align="center">
        <img src="templates/09_REL_relationship_correlation/09_REL_019/assets/preview.png" alt="散点矩阵热力图预览" width="100%">
        <br>
        <sub>散点矩阵热力图</sub>
      </td>
      <td width="50%" align="center">
        <img src="templates/10_SEN_sensitivity_robustness/10_SEN_006/assets/preview.png" alt="多关系散点面板预览" width="100%">
        <br>
        <sub>多关系散点面板</sub>
      </td>
    </tr>
    <tr>
      <td width="50%" align="center">
        <img src="templates/10_SEN_sensitivity_robustness/10_SEN_015/assets/preview.png" alt="敏感性等高线矩阵预览" width="100%">
        <br>
        <sub>敏感性等高线矩阵</sub>
      </td>
      <td width="50%" align="center">
        <img src="templates/11_SPA_spatial_geographic/11_SPA_001/assets/preview.png" alt="空间主导因子图预览" width="100%">
        <br>
        <sub>空间主导因子图</sub>
      </td>
    </tr>
...
其中「映射 pip 包名」依赖 `docs/package_name_mapping.yaml`：该表只登记 import 名与 pip 包名的明确映射，未收录的 import 不会由模型猜测包名，而是在依赖检查阶段直接中止并提示。新增模板若引入第三方库，需要同步补充这张映射表。
