...
def test_readme_exists_and_matches_skill_project_positioning():
    ...
    assert (
        "覆盖聚类降维、相关性、分布不确定性、预测评估、敏感性分析、网络关系、空间分析和时序趋势"
        in text
    )
...
def test_readme_referenced_project_paths_exist():
    ...
    referenced_paths = [
        ...
        "templates/01_CLU_clustering_reduction/01_CLU_001/assets/preview.png",
        "templates/01_CLU_clustering_reduction/01_CLU_002/assets/preview.png",
        "templates/10_SEN_sensitivity_robustness/10_SEN_005/assets/preview.png",
        "templates/10_SEN_sensitivity_robustness/10_SEN_011/assets/preview.png",
        "templates/09_REL_relationship_correlation/09_REL_005/assets/preview.png",
        "templates/09_REL_relationship_correlation/09_REL_013/assets/preview.png",
        "templates/06_NET_network_flow/06_NET_001/assets/preview.png",
        "templates/03_EVL_composite_evaluation/03_EVL_002/assets/preview.png",
        "templates/01_CLU_clustering_reduction/01_CLU_004/assets/preview.png",
        "templates/02_CMP_comparison_ranking/02_CMP_001/assets/preview.png",
        "templates/01_CLU_clustering_reduction/01_CLU_003/assets/preview.png",
        "templates/02_CMP_comparison_ranking/02_CMP_012/assets/preview.png",
        "templates/04_DIS_distribution_uncertainty/04_DIS_006/assets/preview.png",
        "templates/05_MPN_multi_panel_report/05_MPN_004/assets/preview.png",
        "templates/09_REL_relationship_correlation/09_REL_016/assets/preview.png",
        "templates/09_REL_relationship_correlation/09_REL_017/assets/preview.png",
        "templates/09_REL_relationship_correlation/09_REL_019/assets/preview.png",
        "templates/10_SEN_sensitivity_robustness/10_SEN_006/assets/preview.png",
        "templates/10_SEN_sensitivity_robustness/10_SEN_015/assets/preview.png",
        "templates/11_SPA_spatial_geographic/11_SPA_001/assets/preview.png",
    ]
    ...
    # README 顶部的 4 个徽章 + 下方的预览图，共 27 个 <img src=...>。
    # 若增删 README 中的图片，需要同步更新这个数字。
    assert text.count("<img src=") == 27
