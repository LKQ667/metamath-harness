...
def load_skill_module():
    candidates = [
        Path(r"C:\\Users\\Lenovo\\.codex\\skills\\math-paper-huashu\\scripts\\plotting\\python_flowchart.py"),
        Path(r"D:\\CodexHome\\.codex\\skills\\math-paper-huashu\\scripts\\plotting\\python_flowchart.py"),
        Path(r"C:\\Users\\Lenovo\\.agents\\skills\\math-paper-huashu\\scripts\\plotting\\python_flowchart.py"),
    ]
    current = Path(__file__).resolve()
    for candidate in candidates:
        if candidate.exists() and candidate.resolve() != current:
            spec = importlib.util.spec_from_file_location("math_paper_huashu_python_flowchart", candidate)
            ...
            return module
    raise RuntimeError("未找到 math-paper-huashu 的 python_flowchart.py")
