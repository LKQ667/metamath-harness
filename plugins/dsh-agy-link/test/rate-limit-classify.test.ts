...
// Captured from a real incident (author paths sanitized): a cortex tool / permission error
...
const REAL_TOOL_ERROR =
  'declaring permissions: cortex tool write_to_file: convert tool call for permissions: model output error: invalid tool call error (invalid_args) /workspace/academic-agent/frontend/src/components/landing/LandingNavbar.tsx is not a valid artifact path; artifacts must be in /workspace/agy-accounts/acc-example/.gemini/antigravity-cli/brain/f94449b8-3395-4b85-bdc1-cba6deeeee94/'
